<script>
  ...
  let bulkMemoTargetFormat = $state(
    /** @type {import("@features/memos/utils/memo_utils").MemoFormat} */ ("markdown")
  );
          ...
          <div class="TaskListToolbar">
            ...
            <div class="TbRow TbButtonsRow" class:TbButtonsRowCompact={isCompact}>
              ...
              {#if !isCompact}
                ...
                <!-- メモの一括変換（データを書き換える操作）と、この先の
                     表示切替（見せ方を変えるだけの操作）の境目。ここだけ
                     区切り線が抜けていて、性質のまったく違う 2 群が地続きに
                     見えていた。 -->
                <span class="TbSep" aria-hidden="true"></span>
              {/if}
